...
import { getEvents, getEventsFiltered, getEvent, getEventsUnassigned, createApplication, assignArtistToEvent, getNeighborhoodsOfEvents } from '../controllers/eventController.js';
...
router.get("/events/neighborhoods", getNeighborhoodsOfEvents);
