import {createArtist, getArtists, getArtist, updateProfile, getUpcomingEventsFromArtist, viewNotifications, getArtistAccount, updateAccount, getNotifications} from '../controllers/artistController.js';
...
router.get("/artists/:id/notifications", getNotifications);
